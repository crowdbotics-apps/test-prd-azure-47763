"""
Django settings for test_prd_azure_47763 project.
...
ROOT_URLCONF = 'test_prd_azure_47763.urls'
...
WSGI_APPLICATION = 'test_prd_azure_47763.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_azure_47763 API",
    "DESCRIPTION": "API documentation for test_prd_azure_47763 App",
    "VERSION": "v1",
}
